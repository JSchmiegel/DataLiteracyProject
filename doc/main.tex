...
%set metadata
\hypersetup{
	pdfauthor={Linus Stenzel, Jonas Schmiegel},
	pdftitle={A descriptive view on Spotify playlists},
	pdfkeywords={Spotify}{Descriptive Statistic},
}
...
\input{chapters/popularVsUnpopular.tex}
