...
We now know that the first $n$ playlists contribute the same amount of unique tracks as the $n^2$ playlists after. The same holds for artists and albums.% This derives from the relationship between artists, album and tracks.
